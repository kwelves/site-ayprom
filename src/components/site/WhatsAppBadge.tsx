const WHATSAPP_NUMBER = "996500461155";
const WHATSAPP_HREF = `https://wa.me/${WHATSAPP_NUMBER}`;

/**
 * Закреплённая кнопка чата WhatsApp — видна на любой странице сайта, поверх
 * остального контента, в одном и том же месте (низ экрана справа), с
 * отступом под "чёлку"/жест-полосу телефона через safe-area-inset. Кольцо
 * пульсирует бесконечно, сама кнопка никогда не скрывается и не сжимается —
 * это единственный прямой канал связи, для которого нет ни скролла, ни
 * состояния "свёрнуто".
 */
