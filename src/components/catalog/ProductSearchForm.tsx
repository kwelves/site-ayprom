...
interface ProductSearchFormProps {
  ...
  defaultValue?: string;
  placeholder: string;
  // Active facet filters (category/brand/vehicleType) carried as hidden
  // inputs so submitting a new search doesn't silently drop them.
...
export function ProductSearchForm({ action, defaultValue, placeholder, hiddenParams }: ProductSearchFormProps) {
  return (
    <form
      action={action}
      method="GET"
