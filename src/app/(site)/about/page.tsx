    ...
    <Container className="py-16 sm:py-24">
      ...
      <Reveal delay={0.05}>
        <div className="mx-auto mt-8 max-w-2xl space-y-4 text-muted-foreground">
          <p>
            AYPROM (Айпром) закрывает одну простую задачу: чтобы поломка гидравлического узла не останавливала вашу
            технику надолго. Работаем из Бишкека с тягачами, самосвалами, тонарами, полуприцепами,
            кранами-манипуляторами и другой спецтехникой.
          </p>
          <p>
