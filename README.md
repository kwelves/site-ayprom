...
- hero-видео: приоритет качества — 3840×2160 (4K UHD) для desktop и mobile;
...
План технических работ и обоснование принятых решений находятся в `docs/ROADMAP.md`; продуктовые ограничения — в `PROJECT_BRIEF.md`.
