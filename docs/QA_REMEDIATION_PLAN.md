...
| Поле | Значение |
|---|---|
| Статус | Активный источник истины; фазы 0–2 завершены после независимой проверки. QA-001, QA-002 и QA-003 закрыты; QA-012 закрыт наполовину (bounds), вторая половина ждёт фазу 3; QA-004…QA-011 остаются открытыми |
